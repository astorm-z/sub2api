...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/astorm-z/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/astorm-z/sub2api
