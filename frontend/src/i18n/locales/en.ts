export default {
  ...
  imageGeneration: {
    ...
    description: 'Use your own API key to create or edit images. The latest result is cached in your browser.',
    ...
    form: {
      ...
      maskImageHint: 'Optional. It will be submitted as the mask field for partial edits.',
    ...
    messages: {
      ...
      cacheCleared: 'The latest cached result has been cleared',
