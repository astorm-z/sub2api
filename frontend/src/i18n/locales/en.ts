export default {
  ...
  imageGeneration: {
    ...
    selectedKeySummary: '{name} · {group}',
    noEligibleKeys: 'No API key is currently available for image generation. Create an active key bound to a balance OpenAI group first.',
    lastCachedAt: 'Last cached: {time}',
    form: {
      apiKey: 'API Key',
      ...
      modeEdit: 'Image edit',
      modeMask: 'Image edit (mask)',
      model: 'Model',
      modelPlaceholder: 'Defaults to gpt-image-2',
      responseModel: 'Responses model',
      responseModelPlaceholder: 'Defaults to gpt-5.5',
      imageModel: 'Image model',
      imageModelPlaceholder: 'Defaults to gpt-image-2',
      modelSelectPlaceholder: 'Select a model',
      prompt: 'Prompt',
      promptPlaceholder: 'For example: Generate an orange cat astronaut sticker in pixel-art style on a pastel background.',
      editPromptPlaceholder: 'For example: Change the cat into orange fur while keeping the composition and mood.',
      maskPromptPlaceholder: 'For example: Change only the red masked area into a blue sweater and keep everything else unchanged.',
      promptHint: 'Describe subject, style, shot, and background for more stable results.',
      editPromptHint: 'For edits, it helps to clearly state what to keep and what to change.',
      maskPromptHint: 'The red painted area is exported as a transparent mask and marks what should be changed.',
      sourceImages: 'Source images',
      sourceImagesSingle: 'Source image (one only)',
      sourceImagesHint: 'Image edit sends one or more source images as references.',
      maskSourceImagesHint: 'Mask mode uses one source image only. The mask is drawn in this page.',
      addImages: 'Add images',
      noSourceImages: 'No source images uploaded yet',
      maskEditor: 'Mask editor',
      maskEditorHint: 'Paint the area to change in red. It will be exported as mask.png when submitted.',
      maskEditorNeedsSource: 'Upload one source image first, then draw the mask area here.',
      maskToolBrush: 'Brush',
      maskToolCircle: 'Circle',
      maskToolRectangle: 'Rectangle',
      maskToolEraser: 'Eraser',
      brushSize: 'Brush size',
      undoMask: 'Undo',
      clearMask: 'Clear mask',
      previewMask: 'Preview mask',
      expandMaskEditor: 'Expand editor',
      exitMaskEditorFullscreen: 'Exit expanded',
      maskPreviewTitle: 'Mask preview: transparent areas will be edited',
      size: 'Size',
      sizeAuto: 'Auto',
      sizeLandscape: '1536 × 1024 (Landscape)',
      sizePortrait: '1024 × 1536 (Portrait)',
      sizeSquare: 'Square',
      sizeLandscapeLabel: 'Landscape',
      sizePortraitLabel: 'Portrait',
      sizeCustom: 'Custom',
      customSize: 'Custom size',
      customSizeWidth: 'Width',
      customSizeHeight: 'Height',
      customSizeWidthPlaceholder: 'e.g. 1024',
      customSizeHeightPlaceholder: 'e.g. 1024',
      customSizeHelpTitle: 'OpenAI custom size limits',
      customSizeHelpMaxEdge: 'Longest edge must be ≤ 3840px',
      customSizeHelpMultiple: 'Both width and height must be multiples of 16px',
      customSizeHelpRatio: 'Long edge to short edge ratio must be ≤ 3:1',
      customSizeHelpPixels: 'Total pixels must be between 655,360 and 8,294,400',
      count: 'Count',
      responseFormat: 'Response format',
      responseFormatBase64: 'b64_json (Recommended)',
      responseFormatUrl: 'url',
      advanced: 'Advanced parameters',
      advancedHint: 'Defaults are enough for most cases. Expand only when needed.',
      quality: 'Quality',
      qualityLow: 'Low',
      ...
      defaultAutoOption: 'Default (auto)',
    },
    actions: {
      clearCache: 'Clear history',
    ...
    result: {
      ...
      emptyDescription: 'Choose a key, write a prompt, and click Generate.',
    ...
    history: {
      ...
      clearConfirmMessage: 'This removes locally saved image-generation history and clears the current results and error state. This cannot be undone.',
      clearConfirmButton: 'Clear history',
    },
    messages: {
      ...
      openedInNewTab: 'The image has been opened in a new tab',
      maskSingleSourceOnly: 'Mask edit supports one source image only. The first image has been kept.',
    },
    errors: {
      loadKeysFailed: 'Failed to load API keys',
      keyRequired: 'Please select an available API key',
      responseModelRequired: 'Please select a Responses model',
      imageModelRequired: 'Please select an image model',
      modelsLoading: 'Models supported by the current key are still loading. Please try again shortly.',
      modelsLoadFailed: 'Failed to load models supported by the current key',
      noResponseModels: 'The current key has no Responses text models available',
      noImageModels: 'The current key has no image generation models available',
      promptRequired: 'Please enter a prompt',
      sourceImagesRequired: 'At least one source image is required in image edit mode',
      maskSourceImageRequired: 'One source image is required in mask edit mode',
      maskDrawingRequired: 'Draw the mask area to edit before submitting',
      countRange: 'Count must be an integer from 1 to 10',
      outputCompressionRange: 'Output compression must be an integer from 0 to 100',
      customSizeRequired: 'Enter a valid custom width and height',
      customSizeMaxEdge: 'OpenAI limits custom image size to a maximum edge of {max}px',
      customSizeMultiple: 'OpenAI requires custom image width and height to be multiples of {multiple}px',
      customSizeRatio: 'OpenAI requires the long edge to short edge ratio to be no more than {ratio}:1',
      customSizePixels: 'OpenAI requires total custom image pixels to be between {min} and {max}',
      maskSourceLoadFailed: 'Failed to load the source image. Please upload it again.',
      maskNotReady: 'The mask editor is not ready yet',
      maskExportFailed: 'Failed to export the mask',
      copyFailed: 'Copy failed. Please copy the link manually.',
      noImagesReturned: 'The request succeeded, but no displayable images were returned',
      streamResponseRequired: 'This image generation page only supports streaming Responses output',
      unsupportedImageFormat: 'Only PNG, JPEG, and WebP images are supported',
      gptImage2TransparentUnsupported: 'gpt-image-2 does not support transparent backgrounds. Use auto or opaque instead.',
