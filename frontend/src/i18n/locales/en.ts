export default {
  ...
  imageGeneration: {
    ...
    noEligibleKeys: 'No API key is currently available for image generation. Create an active key bound to an OpenAI group first.',
    ...
    form: {
      ...
      sourceImagesHint: 'Upload one or more images. They will be submitted as repeated image fields to the edits endpoint.',
      maskSourceImagesHint: 'Mask edit uses one source image only. If multiple images are selected, only the first one is kept.',
      ...
      moderationLow: 'Low',
      moderationHelp: 'Controls upstream safety review strength for prompts and generated content. Keeping Auto is usually the safest choice; lower settings may still be ignored or blocked upstream.',
      ...
      outputCompressionPlaceholder: 'For example 90',
      partialImages: 'Partial preview count',
      partialImagesHelp: 'Requests intermediate previews during generation. This only works when the upstream supports partial previews, and higher values usually return more data.',
      partialImagesPlaceholder: 'For example 1',
      optionAuto: 'Auto',
    ...
    errors: {
      ...
      sourceImagesRequired: 'At least one source image is required in edit mode',
