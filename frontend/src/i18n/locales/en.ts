export default {
  ...
  imageGeneration: {
    ...
    form: {
      ...
      sourceImagesHint: 'Image edit can use one or more source images.',
      ...
      partialImagesPlaceholder: 'For example 2',
      optionAuto: 'Auto',
    ...
    errors: {
      ...
      partialImagesRange: 'Partial preview count must be an integer from 0 to 3',
