export default {
  ...
  imageGeneration: {
    ...
    noEligibleKeys: '当前没有可用于 AI 生图的 API Key。请先创建并绑定 OpenAI 分组的可用密钥。',
    ...
    form: {
      ...
      sourceImagesHint: '图生图可上传一张或多张源图。',
      ...
      partialImages: '局部预览数',
      partialImagesHelp: '请求生成过程中的中间预览张数。只有上游支持局部预览时才会生效，数值越大返回内容通常也越多。',
      partialImagesPlaceholder: '例如 2',
      optionAuto: '自动',
      defaultOption: '默认',
    ...
    errors: {
      ...
      partialImagesRange: '局部预览数必须是 0 到 3 之间的整数',
