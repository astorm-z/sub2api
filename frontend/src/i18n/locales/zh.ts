export default {
  ...
  imageGeneration: {
    ...
    form: {
      ...
      sourceImages: '原始图片',
      sourceImagesHint: '支持一次上传多张图片，系统会作为 edits 接口的 image 字段提交。',
      maskSourceImagesHint: '遮罩编辑只使用一张原始图片；如果选择多张，将保留第一张。',
      addImages: '添加图片',
    ...
    errors: {
      ...
      sourceImagesRequired: '改图模式至少需要上传一张原始图片',
